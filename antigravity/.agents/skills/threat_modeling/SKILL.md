...
The primary output of this skill is a **Threat Model Artifact** (`threat_model.md` located at the root of the workspace). This artifact is directly consumed by the **Test-Driven Development (TDD) Skill** to guide the creation of security-hardening tests.
