...
description: Threat modeling workflow to map entry points, trust boundaries, and sensitive data paths and produce a threat_model.md artifact. Use at the start of a security review, or when planning a component that handles untrusted input or crosses a trust boundary.
---
